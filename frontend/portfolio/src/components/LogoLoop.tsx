...
const useResizeObserver = (
  ...
  const elementsCurrents = React.useMemo(
    () => elements.map((e) => e.current),
    [elements]
  );
  useEffect(() => {
    ...
    // We key the effect by ref identity and callback reference.
  }, [callback, elements, elementsCurrents]);
};
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    const isNodeItem = (
      i: LogoItem
    ): i is Extract<LogoItem, { node: React.ReactNode }> => "node" in i;
